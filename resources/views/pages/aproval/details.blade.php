...
<div class="flex flex-col gap-1 lg:col-span-2 mt-12 px-10 mb-10">
    ...
    <div class="h-24 border-l-4 border-black ml-2.5">
        <input disabled type="text" name="ship_name" class="p-3 rounded-xl border mt-3 ml-3  w-full "
    ...
    <label for="ship_flag" class="flex items-center gap-3 text-lg">
        ...
        Flag</label>
    <div class="h-24 border-l-4 border-black ml-2.5">
        <select disabled id="country" name="ship_flag" class="w-full p-3 border rounded-2xl ml-3 ">
    ...
    <label for="ship_line" class="flex items-center gap-3 text-lg">
        ...
        Line</label>
    <div class="h-24 border-l-4 border-black ml-2.5">
        <input disabled type="text" name="ship_line" class="p-3 rounded-xl border mt-3 ml-3  w-full "
    ...
    <label for="ship_cargo" class="flex items-center gap-3 text-lg">
        ...
        Cargo</label>
    <div class="h-24 border-l-4 border-black ml-2.5">
        <input disabled type="text" name="ship_cargo" class="p-3 rounded-xl border mt-3 ml-3  w-full "
    ...
    <label for="ship_t_bongkar" class="flex items-center gap-3 text-lg">
        ...
        T/Bongkar</label>
    <div class="h-24 border-l-4 border-black ml-2.5">
        <input disabled type="text" name="ship_t_bongkar" class="p-3 rounded-xl border mt-3 ml-3  w-full "
    ...
    <label for="ship_t_muat" class="flex items-center gap-3 text-lg">
        ...
        T/Muat</label>
    <div class="h-24 border-l-4 border-black ml-2.5">
        <input disabled type="text" name="ship_t_muat" class="p-3 rounded-xl border mt-3 ml-3 w-full "
